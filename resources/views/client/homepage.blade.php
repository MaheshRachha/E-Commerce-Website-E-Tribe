		...
		<!-- Home Slider -->
			<div class="home_slider_container">
				<div class="owl-carousel owl-theme home_slider">
					...
					<!-- Slide -->
					<div class="owl-item">
						<div class="background_image" style="background-image:url({{asset('client/images/32.jpg')}})"></div>
						<div class="home_content_container">
							<div class="home_content">
								<div class="home_title" style="color:black;">20 % Discount on the <br>New Arts Collection  </div>
								<div class="button button_1 home_button trans_200"><a href="">Shop</a></div>
							</div>
						</div>
					</div>
					...
					<!-- Slide -->
					<div class="owl-item">
						<div class="background_image" style="background-image:url({{asset('client/images/80.jpg')}})"></div>
						<div class="home_content_container">
							<div class="home_content">
                    ...
                    <!-- Slide -->
					<div class="owl-item">
						<div class="background_image" style="background-image:url({{asset('client/images/category-1.jpg')}})"></div>
						<div class="home_content_container">
							<div class="home_content">
								<div class="home_title" style="color:black;">20 % Discount on the <br>New Forest Products Collection  </div>
								<div class="button button_1 home_button trans_200"><a href="{{url('login')}}">Shop</a></div>
							</div>
						</div>
					</div>
