...
<div class="super_container">
	...
	<div class="sidebar" >
		...
		<div class="sidebar_logo">
			<a href="{{asset('supplier/#')}}"><div>E-<span>Tribe</span></div></a>
		</div>

		<!-- Sidebar Navigation -->
		<nav class="sidebar_nav" >
			<ul>
				<li><a href="{{url('/supplier_home')}}">home<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
						...
						<div class="col-xxl-3 col-md-6 footer_col">
							<div class="footer_about">
								...
								<div class="footer_logo" >
									<a href="{{asset('supplier/#')}}"><div>E-<span style="color:white;">Tribe</span></div></a>
								</div>
								<div class="cards">
									<ul class="d-flex flex-row align-items-center justify-content-start">
										<li><a href="{{asset('supplier/#')}}"><img src="{{asset('supplier/images/card_1.jpg')}}" alt=""></a></li>
										<li><a href="{{asset('supplier/#')}}"><img src="{{asset('supplier/images/card_2.jpg')}}" alt=""></a></li>
										<li><a href="{{asset('supplier/#')}}"><img src="{{asset('supplier/images/card_4.jpg')}}" alt=""></a></li>
										<li><a href="{{asset('supplier/#')}}"><img src="{{asset('supplier/images/card_3.jpg')}}" alt=""></a></li>
										<li><a href="{{asset('supplier/#')}}"><img src="{{asset('supplier/images/card_5.jpg')}}" alt=""></a></li>
									</ul>
								</div>
							</div>
						</div>
